...
import anh_1 from '../../asset/dichvu/vesinh/anh_1.jpg'
import anh_2 from '../../asset/dichvu/vesinh/anh_2.jpg'
import anh_3 from '../../asset/dichvu/vesinh/anh_3.jpg'
import anh_4 from '../../asset/dichvu/vesinh/anh_4.jpg'
import anh_5 from '../../asset/dichvu/vesinh/anh_5.jpg'
    ...
    <div className="row vscn-chi-tiet">
      <div className="clearfix w-100" style={{display: 'table'}}>
        <div className="vscn-content">
          ...
          <div className="vscn-detail col-sm-12 mt-2" style={{lineHeight: '20px'}}>Để duy trì vệ sinh, chăm sóc sàn nhà, duy trì mỹ quan bên trong tòa nhà thì có công việc tiến hành hàng ngày và có công việc tiến hành định kỳ <br />
